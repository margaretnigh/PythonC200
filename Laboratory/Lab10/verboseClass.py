...
class Example: # A class
    # This is the constructor. When you create an instance, this is the first 
#function called. 
    ...
    def aFunction(self, someValue):
        """
        This is an instance function. A function that works off of the information 
in the instance
        """
    ...
    def getID(self):
        ...
        This will return the "memory id" of the self variable, showing it is the 
same as the instance that 
...
print("Memory ID showing instances:", id(anInstance1), anInstance1.getID(), 
id(anInstance1) == anInstance1.getID())
